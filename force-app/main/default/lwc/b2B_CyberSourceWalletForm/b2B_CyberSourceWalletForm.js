...
export default class B2B_CyberSourceWalletForm extends NavigationMixin(
  LightningElement
) {
  kId;
  microform;
            ...
            if (self.is3DSecure) {
              ...
              if(self.saveFromWallets){
                ...
                .then((result) => {
                  ...
                  const evt = new ShowToastEvent({
                    title: "Saved",
                    message: "Payment Method has been saved successfully and and will be added soon.",
                    variant: "success",
                    mode: "dismissable"
                  });
                ...
                .catch((error) => {
                  ...
                  this.dispatchEvent(evt);
                  console.log(
                    "____Error while calling server_____ 2" +
                      JSON.stringify(error)
                  );
                });
              }else{
                AuthorizationAPI({
                  ...
                  .catch((error) => {
                    ...
                    this.dispatchEvent(evt);
                    console.log(
                      "____Error while calling server_____ 3" +
                        JSON.stringify(error)
                    );
                  });
                }
